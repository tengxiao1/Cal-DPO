...
from alignment_handbook_spin import (
    DataArguments,
    H4ArgumentParser,
    ModelArguments,
    # get_checkpoint,
...
from scripts.dpo_trainer import DPOTrainer
# from scripts.spin_trainer import SPINTrainer

logger = logging.getLogger(__name__)
logger.setLevel(logging.DEBUG)
# 强制 datasets 库在离线模式下运行
...
def main():
    ...
    last_checkpoint = None # mingxiaoli
